...
/**
 * The reactive jaxb integration test.
 *
...
class ReactiveJaxbIntegrationTest {
  ...
  void postPerson() {
    ...
    webClient
        ...
        .value(person -> assertThat(person).isEqualTo(model));
  ...
  void postVehicle() {
    ...
    webClient
        ...
        .value(vehicle -> assertThat(vehicle).isEqualTo(model));
  }
  ...
  void postVehicles() {
    ...
    webClient
        ...
        .value(vehicles -> assertThat(vehicles).isEqualTo(model));
  }
  ...
  void postCompany() {
    ...
    webClient
        ...
        .value(company -> assertThat(company).isEqualTo(model));
  }
  ...
  void postAddress() {
    ...
    webClient
        ...
        .value(address -> assertThat(address).isEqualTo(model));
  }
