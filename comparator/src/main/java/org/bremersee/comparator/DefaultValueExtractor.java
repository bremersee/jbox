...
/**
 * The default value extractor supports field names and paths as described in {@link SortOrderItem}.
 * A field name can be just the field name (for example {@code firstName}), a method name, that is
 * not generated by {@link ValueExtractor#getPossibleMethodNames(String)} (for example
 * {@code toString}) or a path of field names separated by dots (.), for example
...
public class DefaultValueExtractor implements ValueExtractor {
   ...
   *
   * @param throwingException if {@code true} and the given field cannot be found,
   *     {@link ValueExtractorException} will be thrown; otherwise {@code null} will be returned
   */
