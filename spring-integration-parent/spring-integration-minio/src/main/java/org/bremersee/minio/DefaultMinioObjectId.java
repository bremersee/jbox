...
public class DefaultMinioObjectId implements MinioObjectId {
   ...
   */
  public DefaultMinioObjectId(MinioObjectId minioObjectId) {
   ...
   * @param name the name
   */
  public DefaultMinioObjectId(String name) {
    this(name, null);
  }
   ...
   */
  public DefaultMinioObjectId(String name, String versionId) {
    this.name = name;
