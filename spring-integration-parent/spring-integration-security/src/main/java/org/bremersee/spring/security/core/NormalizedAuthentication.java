...
public interface NormalizedAuthentication extends Authentication {
  ...
  /**
   * The empty normalized authentication.
   */
  final class EmptyNormalizedAuthentication implements NormalizedAuthentication {

    /**
     * Instantiates a new empty normalized authentication.
     */
    public EmptyNormalizedAuthentication() {
      super();
    }
    ...
    public void setAuthenticated(boolean isAuthenticated) throws IllegalArgumentException {
      throw new UnsupportedOperationException("Setting authenticated is not supported.");
    }
