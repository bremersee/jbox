...
public interface MultipartFileBuilder {
   ...
   * @return the multipart file
   */
  Mono<MultipartFile> build(Flux<? extends Part> parts);
   ...
   */
  Mono<List<MultipartFile>> buildList(Flux<? extends Part> parts);
  ...
  Mono<Map<String, MultipartFile>> buildMap(Flux<? extends Part>... parts);
  ...
  /**
   * Get multipart file with the specified request parameter name. If no such multipart file exists,
